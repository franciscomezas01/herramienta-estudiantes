...
def convertir_audio():
    nombre_carpeta = entrada_carpeta.get()
    nombre_archivo = nombre_carpeta
    ruta_archivo_audio = os.path.join(os.path.expanduser("~"), "Desktop", nombre_carpeta)
    print(ruta_archivo_audio)
    if os.path.exists(ruta_archivo_audio):
        ruta_archivo_txt, ruta_archivo_docx = AudioTexto.convertir_audio_a_texto(ruta_archivo_audio, nombre_archivo)
